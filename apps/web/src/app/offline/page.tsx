...
export const metadata: Metadata = {
  title: "Offline mode",
  description: "NGPDFs keeps working without internet after its first load. Here is how offline mode works.",
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 pb-20 pt-10">
      ...
      <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        NGPDFs before, all tools remain fully functional - your files were always going to be
      ...
      <p className="mt-6 text-xs text-slate-400">
        First-time visitors need one online visit to cache the app. After that, NGPDFs is a
