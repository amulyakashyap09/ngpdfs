...
export function PdfToAudioClient() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <p className="rounded-xl border border-blue-300 bg-blue-50 p-3 text-sm text-blue-950 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-100"><strong>Listen in this browser:</strong> PaperZero extracts reading text locally and uses the browser&apos;s installed SpeechSynthesis voices. Browsers do not expose the synthesized PCM as a reliable audio Blob, so this route intentionally offers no fake MP3/WAV download.</p>
